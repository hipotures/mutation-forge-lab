...
Implement only priority(ctx, proposal) under the function contract above. State a falsifiable hypothesis in metadata. Return exactly keys schema_version, source, design_summary, used_fields, assumptions; no extra keys or prose.
