...
The Native v3 selector introduced in Step 10 remains:
...
`native-v3-preview.v2` marker and unchanged configuration identity. A Native v2
...
Step 11 superseded the original one-slot smoke behavior with the deterministic
